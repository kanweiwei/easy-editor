...
export default (function (e, change, self, options) { return __awaiter(void 0, void 0, void 0, function () {
    var maxImageHeight, maxImageWidth, onlyText, imgStyle, transfer, _a, file_1, url, html, reg, localeImgs, supportFileTypes, supportRtfTypes, result, _loop_1, i, rootDom, getInvalidImgs_1, invalidImgs, y, foundIndex, body, document, blocks, firstBlock;
        ...
        switch (_b.label) {
            case 0:
                ...
                switch (_a) {
                    ...
                    case "fragment": return [3 /*break*/, 5];
                    case "node": return [3 /*break*/, 5];
                    case "rich": return [3 /*break*/, 5];
