        ...
        switch (blockType) {
          case "table-body":
            return {
              ...
              type: blockType,
              nodes: next(
                _filterInstanceProperty((_context = el.childNodes)).call(
                  _context,
                  function (childNode) {
          ...
          case "table-row":
            return {
              ...
              type: blockType,
              nodes: next(
                _filterInstanceProperty((_context2 = el.childNodes)).call(
                  _context2,
                  function (childNode) {
          ...
          case "table-cell":
            return {
              ...
              type: blockType,
              nodes: next(
                _filterInstanceProperty((_context3 = el.childNodes)).call(
                  _context3,
                  function (childNode) {
                    var _context4;
                    ...
                    if (
                      ...
                      _trimInstanceProperty((_context4 = childNode.value)).call(
                        _context4
                      ).length === 0
                    ) {
                      return false;
          ...
          default: {
            ...
            _forEachInstanceProperty((_context5 = el.attrs)).call(
              _context5,
              function (attr) {
  ...
  },
  {
    deserialize: function deserialize(el, next) {
      ...
      if (inlineType) {
        ...
        if (
          className &&
          _indexOfInstanceProperty(className).call(className, "dot") > -1
        ) {
          markType = "dot";
        }
    ...
    deserialize: function deserialize(el) {
      if (el.nodeName && el.nodeName === "#text") {
        if (el.value) {
          ...
          if (
            _trimInstanceProperty((_context6 = el.value)).call(_context6)
              .length > 0
          ) {
            return {
              object: "text",
          ...
          if (
            el.value.length >= 3 &&
            _trimInstanceProperty((_context7 = el.value)).call(_context7)
              .length === 0
          ) {
            return {
              object: "text",
